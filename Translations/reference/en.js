  ...
  (_global.HTMLCS_Section508 = {
      ...
      testHeadingOrder: function (a) {
        for (var b = 0, c = HTMLCS.util.getAllElements(a, 'h1, h2, h3, h4, h5, h6'), d = 0; d < c.length; d++) {
          ...
          if (e - b > 1) {
            ...
            0 === b && (f = 'appears to be the primary document heading, so should be an h1 element'),
              HTMLCS.addMessage(
                HTMLCS.ERROR,
                c[d],
                'The heading structure is not logically nested. This h' + e + ' element ' + f + '.',
                'HeadingOrder'
              );
          }
          b = e;
          ...
          if (f - c > 1) {
            ...
            0 === c && (g = 'appears to be the primary document heading, so should be an h1 element'),
              HTMLCS.addMessage(
                b,
                d[e],
                'The heading structure is not logically nested. This h' + f + ' element ' + g + '.',
                'G141'
              );
          }
          c = f;
    ...
    (_global.HTMLCS_WCAG2AAA_Sniffs_Principle1_Guideline1_4_1_4_3_Contrast = {
      ...
      recommendColour: function (a, b, c) {
        ...
        if (d < c) {
          ...
          g = { fore: { from: b, to: l }, back: { from: a, to: m } };
        }
        return g;
      },
      ...
      process: function (a, b) {
        if (a === b)
          for (
            ...
            var l = [];
            h &&
              (h.fore.from !== h.fore.to && l.push('text colour to ' + h.fore.to),
              h.back.from !== h.back.to && l.push('background to ' + h.back.to)),
              l.length > 0 && (l = ' Recommendation: change ' + l.join(', ') + '.'),
              !0 === j
                ? ((k += '.Abs'),
                  HTMLCS.addMessage(
                    HTMLCS.WARNING,
            ...
            !0 !== /^\s*$/.test(f) &&
              (void 0 !== d[f]
                ? HTMLCS.addMessage(
                    HTMLCS.ERROR,
                    c[e],
                    'Duplicate id attribute value "' + f + '" found on the web page.',
                    'F77'
                  )
                : (d[f] = !0));
          }
    ...
    (_global.HTMLCS_WCAG2AAA_Sniffs_Principle4_Guideline4_1_4_1_2 = {
      ...
      processFormControls: function (a) {
        ...
        for (var i = { select: 'option_selected' }, j = 0, k = b.length; j < k; j++) {
          var l = b[j],
          ...
          if ((o || 'input_hidden' === m || (o = ['_content']), o)) {
            ...
            if (g === o.length) {
              ...
              var x =
                ...
                v.join(', ') +
                '.';
              c.push({ element: l, msg: x, subcode: n + '.Name' });
            }
          }
          var y = !1;
          if (void 0 === p) y = !0;
          ...
          if ((!1 === y && (valuFound = HTMLCS.util.hasValidAriaLabel(l)), !1 === y)) {
            ...
            var x = 'This ' + u + ' does not have a value available to an accessibility API.',
              ...
              B = !1;
            '_content' === p
              ? (A = ' Add one by adding content to the element.')
              : 'option_selected' === p
              ? ((B = !0),
                (x =
                  'This ' +
                  u +
                  ' does not have an initially selected option. Depending on your HTML version, the value exposed to an accessibility API may be undefined.'))
              : (A =
                  '@' === p.charAt(0)
                    ? ' A value is exposed using the "' + p + '" attribute.'
                    : ' A value is exposed using the "' + p + '" element.'),
              (x += A),
              !1 === B
                ? c.push({ element: l, msg: x, subcode: n + '.Value' })
                : d.push({ element: l, msg: x, subcode: n + '.Value' });
          }
        }
        return { errors: c, warnings: d };
      },
    }),
    (_global.HTMLCS = new (function () {
      ...
      (this.ERROR = 1),
        ...
        (this.addMessage = function (a, b, c, d, e) {
          (d = r(d)), f.push({ type: a, element: b, msg: g[d] || c, code: d, data: e });
        }),
        ...
        m = function (a, b, c, d) {
          if ('string' == typeof b) {
            ...
            j(
              ...
              d,
              { exclude: b.exclude, include: b.include }
            );
        },
        n = function (a, d) {
          var e = q(a, d);
    ...
    (_global.HTMLCS.util = (function () {
      ...
      return (
        ...
        (a.sRGBtoHSV = function (b) {
          ...
          var c = { hue: 0, saturation: 0, value: 0 },
        ...
        (a.getCellHeaders = function (a) {
          ...
          for (
            var b = a.getElementsByTagName('tr'), c = [], d = { rows: {}, cols: {} }, e = [], f = ['th', 'td'], g = 0;
            g < f.length;
            g++
          )
                  ...
                  if (n === h)
                    if ('th' === n) {
                      for (var s = m.getAttribute('id') || '', q = i; q < i + o; q++)
                        (d.rows[q] = d.rows[q] || { first: k, ids: [] }), d.rows[q].ids.push(s);
                      for (var q = k; q < k + p; q++)
                        (d.cols[q] = d.cols[q] || { first: i, ids: [] }), d.cols[q].ids.push(s);
                    } else if ('td' === n) {
